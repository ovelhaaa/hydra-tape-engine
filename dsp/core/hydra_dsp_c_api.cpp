...
static const hydra_dsp_param_spec kParamSpecs[HYDRA_DSP_PARAM_COUNT] = {
    {HYDRA_DSP_PARAM_FLUTTER_DEPTH, "flutterDepth", 0.0f, 45.0f, 14.0f, HYDRA_DSP_SMOOTHING_BLOCK_EDGE, HYDRA_DSP_PARAM_SPEC_FLAG_NONE},
    {HYDRA_DSP_PARAM_WOW_DEPTH, "wowDepth", 0.0f, 35.0f, 10.0f, HYDRA_DSP_SMOOTHING_BLOCK_EDGE, HYDRA_DSP_PARAM_SPEC_FLAG_NONE},
    {HYDRA_DSP_PARAM_DROPOUT, "dropoutSeverity", 0.0f, 40.0f, 5.0f, HYDRA_DSP_SMOOTHING_BLOCK_EDGE, HYDRA_DSP_PARAM_SPEC_FLAG_NONE},
